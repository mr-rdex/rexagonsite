...
const AdminPage = () => {
  ...
  const tabs = [
    ...
    { id: 'market', label: 'Market', icon: <Package size={18} /> },
    { id: 'news', label: 'Haberler', icon: <Newspaper size={18} /> },
    { id: 'reports', label: 'Raporlar', icon: <AlertCircle size={18} /> },
    { id: 'themes', label: 'Temalar', icon: <Palette size={18} /> },
    { id: 'settings', label: 'Site Ayarları', icon: <Settings size={18} /> },
    ...
    { id: 'rcon', label: 'RCON Konsolu', icon: <Terminal size={18} /> }
  ];
                    ...
                    <div className="flex flex-col gap-4 mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <select className={inputCls} value={newAmbiance.tip} onChange={e => setNewAmbiance({...newAmbiance, tip: e.target.value})}>
                          ...
                          <option value="yaz">Ateş Böceği Efekti</option>
                        </select>
